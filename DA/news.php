...
<body class="nunito">
    ...
    <main class="nunito container mx-auto">
        <section class="flex container mx-auto my-5">
            ...
            <h3><a class="uppercase text-sm font-bold" href="news.php">Bản tin du lịch</a></h3>
        </section>
        <section class=" py-12 mx-10">
            ...
            <div class="grid grid-cols-12 gap-10 px-16 my-10 group">
                ...
                <div class="col-span-9">
                    ...
                    <a href=""><span class="flex justify-end items-center group-hover:text-yellow-500 py-2">Xem thêm <i class="fas fa-long-arrow-alt-right pl-2"></i></span></a>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-10 px-16 my-10 group">
                <div class="col-span-3">
