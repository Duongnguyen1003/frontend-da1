...
<body class="nunito relative">
    <div id="main" class="hidden">
        <header class="relative">
            <img src="./content/image/background/bg-success.jpg" alt="">
                    ...
                    <tbody class="text-center">
                        <tr class="border">
                            ...
                            <td class=" flex justify-between py-2">
                                <img class="px-2" style="height: 120px;width: 240px;" src="./content/image/1.jpg" alt="">
                                <span class="flex items-center">LĂNG CHỦ TỊCH - BẢO TÀNG DÂN TỘC HỌC - VĂN MIẾU QUỐC TỬ GIÁM - CHÙA TRẤN QUỐC</span>
                            </td>
                            <td class="border px-2">1,500,000₫</td>
                            <td class="border px-2">1</td>
                            <td class="border px-2"></td>
                            <td class="border px-2"><button class="flex mx-auto items-center focus:outline-none text-xl"><i class="far fa-trash-alt hover:text-red-500 text-gray-400"></i></button></td>
                        </tr>
                        <tr class="border">
    ...
    <div id="show" class="relative h-screen overflow-hidden">
        ...
        <img class="opacity-50" src="./content/image/background/bg-subSuccess.jpg" alt="">
        <div class="grid grid-cols-2 mx-auto container bg-white absolute top-0 bottom-0 left-0 right-0 my-auto" style="height: 450px;">
            <div class="ml-28 my-auto">
                ...
                <span class="block capitalize text-sm text-center my-3">cảm ơn quý khách đã quan tâm đến Hanoitourist</span>
                <span class="block bg-gray-300 py-2 px-10 text-center font-bold my-3">Tour du lịch của Quý Khách đang được xử lý</span>
                ...
                <p class="block text-center">Nhân viên của chúng tôi sẽ liên hệ với Quý Khách trong thòi gian sớm nhất. Nếu có thắc mắc, Quý Khách vui lòng liên hệ qua số hotline <span class="text-red-500">1900 1000</span>.</p>
            ...
            <div class="my-auto relative">
                ...
                <img class="object-fill mx-auto rounded-full" style="height: 415px;width: 415px;" src="./content/image/du-lich-an-toan (1).jpg" alt="">
            </div>
        </div>
