        ...
        <section class="bg-white my-5">
            <div class="container mx-auto grid grid-cols-12 gap-10 justify-center">
                ...
                <div class="col-span-6 my-5 bg-gray-100 bg-opacity-50">
                    ...
                    <h2 class="font-bold text-3xl bg-yellow-300 py-2 px-5"><?php echo $totall['name_tour'] ?></h2>
                    ...
                    <div class="px-5">
                        ...
                        <div class="bg-gray-50 px-10 py-2">
                            ...
                            <span class="text-3xl px-5 text-red-600 font-bold"><?php echo number_format($totall['price'], 0, '.', ',') ?>
                                ₫/khách</span>
                        </div>
                        ...
                        <div class="flex items-center ">
                            ...
                            <p class="ml-10"><i class="fas fa-map-marker-alt py-2 pr-2"></i><?php echo $totall['place_start'] ?></p>
                        </div>
                        <div class="my-10">
                            <a href="cart.php" class=" text-black border hover:border-yellow-400 px-12 py-3 w-full text-base rounded bg-red-400 hover:bg-white text-center">Đặt
                                ngay</a>
                        </div>
